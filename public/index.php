...
<main class="warm-background py-5 ">
    ...
    <div class="container my-5">
        <h3 class="text-center mb-4 font-bold">Meet Our Trainers</h3>
        <div class="row">
            <?php foreach ($trainers as $trainer): ?>
            <div class="col-lg-4 my-4">
                <div class="card h-100">
                    <img src="<?= htmlspecialchars($trainer['image_url']); ?>" class="card-img-top img-fluid" style="height: 500px; object-fit: cover;" alt="<?= htmlspecialchars($trainer['name']); ?>">
                    <div class="card-body">
                        <h5 class="card-title font-bold"><?= htmlspecialchars($trainer['name']); ?></h5>
                        <p class="card-text text-secondary"><?= htmlspecialchars($trainer['specialties']); ?></p>
